...
public class LogisticRegression : IMlStrategy
{
    ...
    public string StrategyName => "Logistic Regression";
    ...
    public void SaveModel(string path)
    {
        ...
        _mlContext.Model.Save(_model, null, path.Replace(".zip", "_logistic.zip"));
    }
