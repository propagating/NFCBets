...
namespace NFCBets.Services
{
    public class FoodClubDataService : IFoodClubDataService
    {
        ...
        public FoodClubDataService(HttpClient httpClient, NfcbetsContext context, IFoodAdjustmentService foodAdjustmentService)
        {
        ...
        private async Task SavePiratePlacementsAsync(int roundId, int arenaId, List<int> pirateIds, List<int> openingOdds, List<int> currentOdds)
        {
            for (int position = 0; position < pirateIds.Count; position++)
            {
        ...
        private async Task SaveRoundResultsAsync(int roundId, int arenaId, List<int> pirateIds, List<int> endingOdds, List<int> winners)
        {
            for (int position = 0; position < pirateIds.Count; position++)
            {
                var pirateId = pirateIds[position];
